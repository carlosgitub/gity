 ...
 */
public class ConstantIsspol {

    public final static String METHOD_GET_ALL_OFICINA_SUCURSAL = "getAllOficinaSucursal";
     ...
     */
    public final static String PROC_USUARIO_INSERTAR = "Seguridad.ProcUsuarioInsertar";
    public final static String AS_USU_USUARIO = "AS_USU_USUARIO";
    public final static String AI_OFICINA = "AI_OFICINA";
    ...
    public final static String Ai_USUARIO_SUPERIOR = "Ai_USUARIO_SUPERIOR";
    public final static String AI_ID_DASHBOARD_INICIO = "AI_ID_DASHBOARD_INICIO";
    public final static String AS_USUARIO = "AS_USUARIO";
    public final static String AI_USU_ID = "AI_USU_ID";
    public final static String AS_MSJ = "AS_MSJ";

    /**
     * Constantes del Procedimiento Ala¡macendado Seguridad.ProcUsuarioActualizar
     */
    public final static String PROC_USUARIO_ACTUALIZAR = "Seguridad.ProcUsuarioActualizar";
    ...
    public final static String PROC_DDDW_ESTRUCTURA_ORGANIZACIONAL = "Seguridad.ProcDddwEstructuraOrganizacional";
